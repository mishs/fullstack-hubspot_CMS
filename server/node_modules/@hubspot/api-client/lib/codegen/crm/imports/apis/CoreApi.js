...
class CoreApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    cancel(importId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (importId === null || importId === undefined) {
                throw new baseapi_1.RequiredError("CoreApi", "cancel", "importId");
            }
    ...
    getById(importId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (importId === null || importId === undefined) {
                throw new baseapi_1.RequiredError("CoreApi", "getById", "importId");
            }
...
class CoreApiResponseProcessor {
    ...
    getPage(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CollectionResponsePublicImportResponse", "");
                return body;
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
