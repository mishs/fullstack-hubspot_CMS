...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(dealId, toObjectType, toObjectId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (dealId === null || dealId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "archive", "dealId");
            }
            ...
            const localVarPath = '/crm/v4/objects/deals/{dealId}/associations/{toObjectType}/{toObjectId}'
    ...
    create(dealId, toObjectType, toObjectId, associationSpec, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (dealId === null || dealId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "create", "dealId");
            }
            if (toObjectType === null || toObjectType === undefined) {
    ...
    getAll(dealId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (dealId === null || dealId === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "dealId");
            }
            if (toObjectType === null || toObjectType === undefined) {
                throw new baseapi_1.RequiredError("AssociationsApi", "getAll", "toObjectType");
            }
            const localVarPath = '/crm/v4/objects/deals/{dealId}/associations/{toObjectType}'
                .replace('{' + 'dealId' + '}', encodeURIComponent(String(dealId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
