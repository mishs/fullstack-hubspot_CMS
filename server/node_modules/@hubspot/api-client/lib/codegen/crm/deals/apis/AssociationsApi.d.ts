...
export declare class AssociationsApiRequestFactory extends BaseAPIRequestFactory {
    archive(dealId: number, toObjectType: string, toObjectId: number, _options?: Configuration): Promise<RequestContext>;
    create(dealId: number, toObjectType: string, toObjectId: number, associationSpec: Array<AssociationSpec>, _options?: Configuration): Promise<RequestContext>;
    getAll(dealId: number, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Promise<RequestContext>;
}
