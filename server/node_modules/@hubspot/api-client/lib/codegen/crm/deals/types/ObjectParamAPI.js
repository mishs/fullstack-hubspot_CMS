...
class ObjectAssociationsApi {
    ...
    archive(param, options) {
        return this.api.archive(param.dealId, param.toObjectType, param.toObjectId, options).toPromise();
    }
    create(param, options) {
        return this.api.create(param.dealId, param.toObjectType, param.toObjectId, param.associationSpec, options).toPromise();
    }
