...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(dealId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (dealId === null || dealId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "dealId");
            }
    ...
    getById(dealId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (dealId === null || dealId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "dealId");
            }
            const localVarPath = '/crm/v3/objects/deals/{dealId}'
                .replace('{' + 'dealId' + '}', encodeURIComponent(String(dealId)));
    ...
    update(dealId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (dealId === null || dealId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "dealId");
            }
            if (simplePublicObjectInput === null || simplePublicObjectInput === undefined) {
