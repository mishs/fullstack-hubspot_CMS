...
export declare class AssociationsApiRequestFactory extends BaseAPIRequestFactory {
    archive(companyId: number, toObjectType: string, toObjectId: number, _options?: Configuration): Promise<RequestContext>;
    create(companyId: number, toObjectType: string, toObjectId: number, associationSpec: Array<AssociationSpec>, _options?: Configuration): Promise<RequestContext>;
    getAll(companyId: number, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Promise<RequestContext>;
}
