...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(companyId, toObjectType, toObjectId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v4/objects/companies/{companyId}/associations/{toObjectType}/{toObjectId}'
    ...
    create(companyId, toObjectType, toObjectId, associationSpec, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (companyId === null || companyId === undefined) {
    ...
    getAll(companyId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v4/objects/companies/{companyId}/associations/{toObjectType}'
                .replace('{' + 'companyId' + '}', encodeURIComponent(String(companyId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
