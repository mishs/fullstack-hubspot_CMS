...
class PromiseAssociationsApi {
    ...
    archive(companyId, toObjectType, toObjectId, _options) {
        const result = this.api.archive(companyId, toObjectType, toObjectId, _options);
        return result.toPromise();
    }
    create(companyId, toObjectType, toObjectId, associationSpec, _options) {
        const result = this.api.create(companyId, toObjectType, toObjectId, associationSpec, _options);
        return result.toPromise();
    }
