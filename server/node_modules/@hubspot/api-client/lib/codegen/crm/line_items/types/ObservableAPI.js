...
class ObservableAssociationsApi {
    ...
    archive(lineItemId, toObjectType, toObjectId, _options) {
        const requestContextPromise = this.requestFactory.archive(lineItemId, toObjectType, toObjectId, _options);
    ...
    create(lineItemId, toObjectType, toObjectId, associationSpec, _options) {
        const requestContextPromise = this.requestFactory.create(lineItemId, toObjectType, toObjectId, associationSpec, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
