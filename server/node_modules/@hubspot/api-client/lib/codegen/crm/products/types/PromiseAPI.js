...
class PromiseAssociationsApi {
    ...
    archive(productId, toObjectType, toObjectId, _options) {
        const result = this.api.archive(productId, toObjectType, toObjectId, _options);
        return result.toPromise();
    }
    create(productId, toObjectType, toObjectId, associationSpec, _options) {
        const result = this.api.create(productId, toObjectType, toObjectId, associationSpec, _options);
        return result.toPromise();
    }
