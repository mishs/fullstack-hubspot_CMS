...
exports.SyncApiResponseProcessor = exports.SyncApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class SyncApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    createContact(appId, syncContactsRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("SyncApi", "createContact", "appId");
            }
            if (syncContactsRequest === null || syncContactsRequest === undefined) {
                throw new baseapi_1.RequiredError("SyncApi", "createContact", "syncContactsRequest");
            }
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(syncContactsRequest, "SyncContactsRequest", ""), contentType);
    ...
    createProduct(appId, syncProductsRequest, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("SyncApi", "createProduct", "appId");
            }
            if (syncProductsRequest === null || syncProductsRequest === undefined) {
                throw new baseapi_1.RequiredError("SyncApi", "createProduct", "syncProductsRequest");
            }
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(syncProductsRequest, "SyncProductsRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["hapikey"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
...
class SyncApiResponseProcessor {
...
//# sourceMappingURL=SyncApi.js.map