...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(meetingId, toObjectType, toObjectId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v4/objects/meetings/{meetingId}/associations/{toObjectType}/{toObjectId}'
    ...
    getAll(meetingId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v4/objects/meetings/{meetingId}/associations/{toObjectType}'
                .replace('{' + 'meetingId' + '}', encodeURIComponent(String(meetingId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
