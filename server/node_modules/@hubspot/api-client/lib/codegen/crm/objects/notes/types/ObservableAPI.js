...
class ObservableAssociationsApi {
    ...
    archive(noteId, toObjectType, toObjectId, _options) {
        const requestContextPromise = this.requestFactory.archive(noteId, toObjectType, toObjectId, _options);
    ...
    create(noteId, toObjectType, toObjectId, associationSpec, _options) {
        const requestContextPromise = this.requestFactory.create(noteId, toObjectType, toObjectId, associationSpec, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
