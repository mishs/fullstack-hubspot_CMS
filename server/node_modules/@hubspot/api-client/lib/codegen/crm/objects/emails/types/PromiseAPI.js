...
class PromiseAssociationsApi {
    ...
    archive(emailId, toObjectType, toObjectId, _options) {
        const result = this.api.archive(emailId, toObjectType, toObjectId, _options);
        return result.toPromise();
    }
    create(emailId, toObjectType, toObjectId, associationSpec, _options) {
        const result = this.api.create(emailId, toObjectType, toObjectId, associationSpec, _options);
        return result.toPromise();
    }
    getAll(emailId, toObjectType, after, limit, _options) {
        const result = this.api.getAll(emailId, toObjectType, after, limit, _options);
        return result.toPromise();
    }
}
