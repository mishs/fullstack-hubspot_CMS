...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(callId, toObjectType, toObjectId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v4/objects/calls/{callId}/associations/{toObjectType}/{toObjectId}'
    ...
    getAll(callId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v4/objects/calls/{callId}/associations/{toObjectType}'
                .replace('{' + 'callId' + '}', encodeURIComponent(String(callId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
