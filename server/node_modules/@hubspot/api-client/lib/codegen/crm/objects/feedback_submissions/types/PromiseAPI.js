...
class PromiseAssociationsApi {
    ...
    archive(feedbackSubmissionId, toObjectType, toObjectId, _options) {
        const result = this.api.archive(feedbackSubmissionId, toObjectType, toObjectId, _options);
        return result.toPromise();
    }
    create(feedbackSubmissionId, toObjectType, toObjectId, associationSpec, _options) {
        const result = this.api.create(feedbackSubmissionId, toObjectType, toObjectId, associationSpec, _options);
        return result.toPromise();
    }
