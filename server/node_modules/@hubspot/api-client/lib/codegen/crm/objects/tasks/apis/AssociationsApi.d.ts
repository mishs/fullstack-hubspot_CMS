...
export declare class AssociationsApiRequestFactory extends BaseAPIRequestFactory {
    archive(taskId: number, toObjectType: string, toObjectId: number, _options?: Configuration): Promise<RequestContext>;
    create(taskId: number, toObjectType: string, toObjectId: number, associationSpec: Array<AssociationSpec>, _options?: Configuration): Promise<RequestContext>;
    getAll(taskId: number, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Promise<RequestContext>;
}
