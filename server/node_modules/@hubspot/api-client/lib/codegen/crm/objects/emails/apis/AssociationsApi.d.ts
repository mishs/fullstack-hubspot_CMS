...
export declare class AssociationsApiRequestFactory extends BaseAPIRequestFactory {
    archive(emailId: number, toObjectType: string, toObjectId: number, _options?: Configuration): Promise<RequestContext>;
    create(emailId: number, toObjectType: string, toObjectId: number, associationSpec: Array<AssociationSpec>, _options?: Configuration): Promise<RequestContext>;
    getAll(emailId: number, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Promise<RequestContext>;
}
