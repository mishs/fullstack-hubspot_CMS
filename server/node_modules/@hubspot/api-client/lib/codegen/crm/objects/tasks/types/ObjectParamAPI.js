...
class ObjectAssociationsApi {
    ...
    archive(param, options) {
        return this.api.archive(param.taskId, param.toObjectType, param.toObjectId, options).toPromise();
    }
    create(param, options) {
        return this.api.create(param.taskId, param.toObjectType, param.toObjectId, param.associationSpec, options).toPromise();
    }
