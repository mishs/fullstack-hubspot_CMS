...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(contactId, toObjectType, toObjectId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v4/objects/contacts/{contactId}/associations/{toObjectType}/{toObjectId}'
    ...
    getAll(contactId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v4/objects/contacts/{contactId}/associations/{toObjectType}'
                .replace('{' + 'contactId' + '}', encodeURIComponent(String(contactId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
