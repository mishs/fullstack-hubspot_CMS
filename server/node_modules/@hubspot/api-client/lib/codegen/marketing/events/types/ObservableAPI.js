...
exports.ObservableSettingsExternalApi = exports.ObservableMarketingEventsExternalApi = exports.ObservableAttendanceSubscriberStateChangesApi = void 0;
...
class ObservableAttendanceSubscriberStateChangesApi {
    ...
    createByEmail(externalEventId, subscriberState, batchInputMarketingEventEmailSubscriber, externalAccountId, _options) {
        ...
        return middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe((0, rxjsStub_2.map)((rsp) => this.responseProcessor.createByEmail(rsp)));
        }));
    }
}
...
const SettingsExternalApi_1 = require("../apis/SettingsExternalApi");
class ObservableSettingsExternalApi {
    constructor(configuration, requestFactory, responseProcessor) {
        this.configuration = configuration;
        this.requestFactory = requestFactory || new SettingsExternalApi_1.SettingsExternalApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new SettingsExternalApi_1.SettingsExternalApiResponseProcessor();
    }
...
exports.ObservableSettingsExternalApi = ObservableSettingsExternalApi;
