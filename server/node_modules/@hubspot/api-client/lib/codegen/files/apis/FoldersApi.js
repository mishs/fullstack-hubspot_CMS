...
class FoldersApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(folderId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (folderId === null || folderId === undefined) {
                throw new baseapi_1.RequiredError("FoldersApi", "archive", "folderId");
            }
    ...
    archiveByPath(folderPath, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (folderPath === null || folderPath === undefined) {
                throw new baseapi_1.RequiredError("FoldersApi", "archiveByPath", "folderPath");
            }
    ...
    checkUpdateStatus(taskId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (taskId === null || taskId === undefined) {
                throw new baseapi_1.RequiredError("FoldersApi", "checkUpdateStatus", "taskId");
            }
    ...
    create(folderInput, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (folderInput === null || folderInput === undefined) {
                throw new baseapi_1.RequiredError("FoldersApi", "create", "folderInput");
            }
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(folderInput, "FolderInput", ""), contentType);
    ...
    getById(folderId, properties, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (folderId === null || folderId === undefined) {
                throw new baseapi_1.RequiredError("FoldersApi", "getById", "folderId");
            }
            const localVarPath = '/files/v3/folders/{folderId}'
                .replace('{' + 'folderId' + '}', encodeURIComponent(String(folderId)));
            const requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
    ...
    getByPath(folderPath, properties, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (folderPath === null || folderPath === undefined) {
                throw new baseapi_1.RequiredError("FoldersApi", "getByPath", "folderPath");
            }
            const localVarPath = '/files/v3/folders/{folderPath}'
                .replace('{' + 'folderPath' + '}', encodeURIComponent(String(folderPath)));
            const requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
    ...
    updateProperties(folderUpdateInput, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (folderUpdateInput === null || folderUpdateInput === undefined) {
                throw new baseapi_1.RequiredError("FoldersApi", "updateProperties", "folderUpdateInput");
            }
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(folderUpdateInput, "FolderUpdateInput", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["hapikey"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
...
class FoldersApiResponseProcessor {
    ...
    checkUpdateStatus(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "FolderActionResponse", "");
                return body;
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    create(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, util_1.isCodeInRange)("201", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Folder", "");
                return body;
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    doSearch(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CollectionResponseFolder", "");
                return body;
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    updateProperties(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, util_1.isCodeInRange)("202", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "FolderUpdateTaskLocator", "");
                return body;
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
